...
# Intento de traducirlo al modelo vectorizado del IFE: (mover anchors para que sean votos 1 y 2)
...
#	gaps[1] ~ dnorm(0, 1.0E-0)
#	gaps[2] ~ dnorm(0, 1.0E-0)
#	promedios[1] ~ dnorm(0.0, 1.0E-0)
#	promedios[2] <- promedios[1] + gaps[1]
#	promedios[3] <- promedios[1] + gaps[2]
}"
