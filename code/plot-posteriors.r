...
# summarize central tendency for plot
...
tit <- "Ugalde, Bonica method"
fil <- "../plots/ugal45-bonica.pdf"
tit <- "Valdés 67 (2007-2010), Bonica method"
fil <- "../plots/vald67-bonica.pdf"
#
#pdf(file = fil)
