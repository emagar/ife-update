...
\item<1->[Before:] Party watchdog model, congressional parties delegate %\\
% {\footnotesize (Estévez, Magar, Rosas 2008)}

\begin{itemize}
\item<1-> Expect party segmentation of IFE's Council General
\item<1-> Ideal point estimation confirms
\end{itemize}

\bigskip

\item<2->[Now:] longitudinal approach to study councilor drift 1996--2014

\begin{itemize}
\item<2-> New puzzles emerge 
\end{itemize}
...
\frame {                      % SLIDE
    ...
    \centering \includegraphics[width=.85\textwidth]{../../pics/calderonIFE20070829.jpg}
...
\item Ran federal elections nationwide 1997--2012, \\ esp. PRI's defeats
...
\centering
Careful delegation $\rightarrow$ \textbf{party} trust $\rightarrow$ citizen trust %\hyperlink{pubop}{\ExternalLink}
...
\frame {                      % SLIDE
  \frametitle{Puzzle 1}
  How do 3 instead of 2 parties affect delegation?
  \begin{itemize}
  \item Party quotas and veto system used (informal) $\rightarrow$ power-sharing
  \item Collective principal appoints a collective agent
  \item Common solution in other `autonomous' regulatory boards (telecomm, energy, education...)
  \end{itemize}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame {                      % SLIDE
  ...
  What if the principal goes out of business?
  
  U.S. has inherited some of this
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame {                      % SLIDE
    \frametitle{Data = contested votes}
