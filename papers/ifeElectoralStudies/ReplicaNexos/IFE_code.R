...
min3 <- min(ife3[,5:6])
max3 <- max(ife3[,5:6])
ife1$lob.s <- (ife1[,5]-min1)/(max1-min1)
ife1$hib.s <- (ife1[,6]-min1)/(max1-min1)
ife1$mean.s <- (ife1[,2]-min1)/(max1-min1)
ife2$lob.s <- (ife2[,5]-min2)/(max2-min2)
ife2$hib.s <- (ife2[,6]-min2)/(max2-min2)
ife2$mean.s <- (ife2[,2]-min2)/(max2-min2)
ife3$lob.s <- (ife3[,5]-min3)/(max3-min3)
ife3$hib.s <- (ife3[,6]-min3)/(max3-min3)
ife3$mean.s <- (ife3[,2]-min3)/(max3-min3)
...
my.dotchart(object[,9],row.names(object), xlim = c(0,1), pch="", main=tt, lcolor="white", cex=1.2)
