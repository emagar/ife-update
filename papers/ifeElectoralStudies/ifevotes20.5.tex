...
\hyphenation{over-re-pre-sent-ing}
%\doublespacing

%%permite usar acentos y otros caracteres en el texto
...
\title{Partisanship in Non-Partisan Electoral Agencies and Democratic Compliance: Evidence from Mexico's Federal Electoral Institute}\thanks{We are grateful to the Weidenbaum Center at Washington University in St. Louis for its generous funding of this research.  Thanks also to Jaime Cárdenas, Brian Crisp, Jacint Jordana, Alonso Lujambio, Andrew Martin, Juan Molinar, Jeffrey Weldon, and two anonymous referees for comments and suggestions, and to Sergio Holguín, Mariana Medina, and Gustavo Robles for research assistance.}
\author{Federico Estévez\\ITAM
\and Eric Magar\\ITAM \and Guillermo Rosas\\Washington University}
\date{}
\maketitle
%\address{Dept. of Political Science\\
%Washington University}
%\author{Federico Estévez}
...
votes cast by members of IFE's Council-General from 1996 to 2005.
Aside from shedding light on IFE's failure to achieve democratic
compliance in 2006, our analysis shows that election arbiters that
embrace partisan strife, rather than expunging party politics from
electoral regulation altogether, can organize free, fair, and
credible elections in new democracies.
\end{abstract}
\vskip 4.5cm
%\pagebreak
\doublespace
...
\begin{flushright}
\singlespacing ``Democracy is a system in which parties lose
...
a future election.%\footnote{Future victories are not the only source of compliance. Losers also accept defeat because they retain some degree of influence on policy until the next election.}
...
optimal position to guarantee fair electoral processes \citep[see
references in][]{LopezPintor2000, Mozaffar2002}. Instead, we suggest
that electoral credibility and compliance with electoral outcomes
can be achieved by granting political parties strong influence
within EMBs, provided that all main parties see themselves
represented in their deliberations.\footnote{\citet{Molina1999}
refer to this setup as the ``party watchdog'' model; \citet[p.
16]{Mozaffar2002a} and \citet[p. 23]{LopezPintor2000} recognize its
...
lost the presidency to the center-right Partido Acción Nacional
...
political parties.%\footnote{Most notably, López Obrador referred to current councilors as ``employees of the PAN and PRI'' (\emph{Reforma}, Sept. 17, 2005), an accusation voiced repeatedly.}
 More importantly, the 2006 election acquired a distinctly
anticlimactic flavor when loser Andrés Manuel López Obrador, the
...
general discussion of the logic of delegation, see \citet[pp.
22-38]{Kiewiet1991}.}  In this light, parties in the enacting
...
with the PT (Councilor Cantú).  The PAN accepted to sponsor only
two members in exchange for strengthening the Council-General's
powers vis-\`{a}-vis IFE's bureaucracy.  In 2003 it was the PRI,
having just re-gained plurality status in the chamber, that demanded
four seats in the new Council-General.%\footnote{Party leader Emilio Chuayffet was fond of echoing would-be presidential candidate Roberto Madrazo's claim to five seats.}
 Since PAN demanded the sponsorship of three members, the PRD
insisted on the acceptance of Councilor Cantú as Council-President
as compensation, but the PRI was unwilling to lift its veto.  At a
...
impeachment against council members, agenda interference through the
filing of petitions and complaints, and recourse to appeal before an
electoral tribunal (we expand on some of these below).  These
mechanisms should make sponsor preferences completely transparent to
councilors.%\footnote{Voice may be ineffectual, of course. \citet{Malo1996} find mixed evidence regarding the effectiveness of two types of party signals (voting cues by Legislative Councilors and authorship of IFE bills) in contested votes in the 1994-1995 period.}
...
Barragán  & PRD & Returned to academic life. \\ [0.5ex]
Cárdenas  & PRD & Returned to academic life. \\ [0.5ex]
Zebadúa   & PRD & PRD Secretary of the Interior in Chiapas (2000-2003), PRD Deputy (2003-2006), minor-party candidate for governor of Chiapas who withdrew along with PAN's candidate (2006). \\ [0.5ex]
Cantú     & PT  & PRD nominee (vetoed) for Council President (2003). \\ [0.5ex]
...
Zebadúa---who assumed government appointments in 2000 and were
...
\includegraphics[width=120mm]{"C:/Documents and Settings/Guillermo Rosas/My Documents/svn/research/PROYECTO IFE/Electoral Studies/fig1"}
...
and former Councilor Zebadúa filed a motion of no confidence
...
appeals from affected parties \citep[cf.][]{SpillerGely1990}. This
...
calls for compromise and accommodation in council decisions. An
obvious implication is that council members will tend to form
oversized, cross-partisan, and even universal voting coalitions. The
obvious strategy for the councilors, given active engagement by the
tribunal and increasing recourse to legal challenge, is to circle
their wagons---that is, to seek safety in broad cross-partisan
consensus.
...
12/16/1997 (vote 28) & PRI, Barragán (Nay)  & Agenda power for President (PRI-sponsored): Should Council-General ratify President's appointee for one administrative office? \\ [1ex]
11/14/2000 (vote 228)  & PRI, Barragán (Aye) & Scope of IFE authority: Should PAN be held responsible and fined for the case of a clergyman who campaigned illegally on its behalf? \\ [1ex]
\multicolumn{3}{l}{\underline{Woldenberg II}} \\ [1ex]
4/6/2001 (vote 27) & Cárdenas, Cantú, Luken (Nay) & Money in elections: Should IFE drop investigation of complaint by Alianza Cívica against the PRI for clientelistic practices in Chiapas? \\ [1ex]
...
8/23/2004 (vote 33) &  PAN minus Morales, Latapí (Nay) &  Agenda power for President (PRI-sponsored): Should candidate for top-level appointment, proposed by Council President without relevant commission's consent, be ratified? \\ [1ex]
1/31/2005 (vote 43) &  Andrade, López Flores, Morales, Gómez Alcántar (Nay) & Scope of IFE authority: Must PVEM statutes make party leaders accountable to rank-and-file?\\[0.5ex]\\ \hline
\end{tabular}
\end{center}
\end{table}
...
are aligned from left to right as follows: Cárdenas, Cantú,
Zebadúa, Lujambio, Molinar, Merino, Woldenberg, Peschard, and
Barragán.
...
three PRI nominees.  The glaring anomaly is Barragán's position at
...
Barragán        & PRD &  3.25  &   1.03 & 204\\ [1ex]
\multicolumn{5}{l}{\underline{Woldenberg II}}  \\ [1.5ex]
Cárdenas        & PRD &--1.67  &   0.23 & 290\\
Barragán        & PRD &  0.40  &   0.12 & 246\\
Cantú           & PT  &  1.70  &   0.20 & 308\\
...
Gómez Alcántar& PVEM&  1.85  &   0.39 & 145\\ \hline
\end{tabular}
\end{center}
\end{table}
...
Rivera occupied Zebadúa's vacant slot between Councilors Cantú and
Lujambio, while Molinar's departure left Councilors Lujambio and
Merino as ideological neighbors.  The PRD's contingent in this
council behaved more cohesively than before, with Barragán
...
council reduced agency costs to his party sponsor.  Barragán's
...
and the PRI.\footnote{Former Councilor Cárdenas consistently
...
conservatives. Of course, Cárdenas's persistent position on the
...
ideological positions of Councilors Barragán in the Woldenberg I
...
\includegraphics[width=120mm]{"C:/Documents and Settings/Guillermo Rosas/My Documents/svn/research/PROYECTO IFE/Electoral Studies/w1_w2_ug"}
...
ideological outliers in Woldenberg I (Barragán) and Ugalde
...
left spanning from Cárdenas to Molinar---to be decisive in
...
analysis has shown that Mexico's electoral regulator, enjoying high
levels of trust by citizens, has manifested partisan behavior within
its ranks since inception. Our results invite cross-national
research to support the broader theoretical claim that election
arbiters that embrace partisan strife, rather than those that
purport to expunge party politics altogether from electoral
regulation, are better able to guarantee free and fair elections in
new democracies.

%In short, our analysis lends credence to the broader theoretical
%claim that election arbiters that embrace partisan strife, rather
%than those that purport to expunge party politics altogether from
%electoral regulation, might be better able to guarantee free and
%fair elections in new democracies.

%MEMO: A VER QUE TE PARECEN ESTAS LINEAS GENERALES DE EXTENSION A TEMAS ALLENDE MEXICO-LINDO-Y-QUERIDO
Our results should also stimulate debate in areas beyond elections.
Miller \citeyearpar{Miller2005} uncovers a whole class of situations
where the classic problem of striking credible commitments is solved
through delegation to agents that remain, to a large extent,
autonomous from principals. Wouldn't checks-and-balances
arrangements suffice in those same situations? The watchdog scheme
has been the model of choice to handle ethnic strife in deeply
divided societies, as evidenced by the United Nations' Minority
Police Recruitment program set in place in Bosnia and Herzegovina in
the second half of the 1990s to organize multi-ethnic police forces
\citep{Collantes2005}.
...
%\tablelasttail{\hline}
%Memo: es possible poner este cuadro en version horizontal en una pï¿1/2/2ina separada? (o de forma que entre en una pagina)
...
%González Luna   & PAN &--1.59  &   0.51 &  53\\
%Sánchez         & PAN &--1.06  &   0.41 &  51\\
%Albo              & PAN &--1.03  &   0.39 &  53\\
%Latapí          & PRI &--0.87  &   0.35 &  53\\
%Ugalde            & PRI &--0.81  &   0.40 &  49\\
%López Flores    & PRI &  0.00  &   0.23 &  46\\
%Andrade           & PRI &  0.54  &   0.32 &  53\\
%Morales           & PAN &  0.98  &   0.40 &  51\\

%Gómez Alcántar& PVEM&  1.82  &   0.58 &  52\\
%$\alpha_{33}$     &     &  2.73  &   1.42 &   \\
%$\alpha_{43}$     &     &--4.60  &   1.67 &   \\
