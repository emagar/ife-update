...
\setboolean{includefigs}{true}  % switch true, false, to see, not see figures
...
%%archivos necesarios para incluir gráficas:
%% fig1.ps
%% w1_w2_ug.ps

\begin{document}\singlespacing
\title{Achieving Democratic Compliance: Partisanship in Mexico's Federal Electoral Institute}
...
%\email{festevez@itam.mx, emagar@itam.mx, grosas@wustl.edu}
%\urladdr{http://poli.wustl.edu/grosas/}
%\date{\today}
%%% THE DOCUMENT STARTS HERE, WITH THE ABSTRACT
\begin{abstract}
We inspect the voting record of an ostensibly independent bureaucratic agent for evidence of partisan behavior.  Our focus is on party delegation of electoral authority to Mexico's \emph{Instituto Federal Electoral} (IFE).  Until a frontal attack by the losing candidate in 2006, IFE was generally credited with skillful oversight and management of Mexico's transition to democracy.  The preponderant view is that IFE's institutional design, which empowers a corps of non-partisan experts to decide on all electoral matters, explains its success.  Our view, instead, is that these experts behave as ``party watchdogs'', reliably representing the interests of the political parties that sponsored them to IFE's Council-General.  To validate the party sponsorship hypothesis, we examine roll-call votes cast by members of IFE's Council-General from 1996 to 2005, using Bayesian MCMC techniques appropriate to the analysis of small committees.  We find evidence of ideological alignments among council members that accord with our expectations of partisan segmentation of IFE.  Our findings illuminate the 2006 failure to achieve democratic compliance in novel ways.\\
...
\begin{flushright}
\singlespacing
Democracy is a system in which parties lose elections. \\ ---Adam Przeworski\footnote{Przeworski 1991, 10.}
\doublespacing
\end{flushright}

One important way in which democracy differs from other forms of
rule is that losers in politics invariably concede victory to
winners, thus bringing predictability. The motives of compliance
with the voters' verdict, however, remain a matter of debate. Some
emphasize the key role of a civic culture shared by the citizenry
(e.g., Putnam 2000); others the need for democracy loyalists to
stick together when extremists perform disruptive actions (e.g.,
Linz and Stepan 1978); or how electoral rules and institutions in
general facilitate or complicate negotiation (e.g., Jones 1995).

We emphasize the importance of trust in electoral fairness, as in
Przeworski's (1991) classic formulation. Losers abide by the ballot
box because they retain a fair chance of winning the next
election.\footnote{Winning in the future is not the only source of
compliance. Losers accept defeat also because, even if small, they
...
impartial toward all parties. Our study of electoral regulation in
Mexico in the last decade shows that credibility and compliance were
achieved repeatedly by granting parties strong influence within the
\emph{Instituto Federal Electoral} (IFE), the authority in charge of
federal elections. Compliance became problematic when one major
party was denied this control.

In a view prevalent among pundits and scholars, what brought credibility to Mexican elections was reform to get rid of institutions giving the PRI, who had been losing votes for at least 20 years nationwide, enormous influence over election regulation. Appointed in 1996 to remain in office until the end of 2003, IFE's reformed Council-General personified non-partisan expertise unencumbered by direct political interference from government \citep{Schedler1999}.  Councilors were thoroughly vetted and recruited from a set of professionals without party affiliation and admitted to the council after winning the consensual endorsement in the Chamber of Deputies.  Once in office, IFE's operational budget, which includes generous public financing for political parties and their election campaigns, is subject to few political whims.  IFE is often heralded as exemplary of the ``ombudsman'' model of electoral management, which welcomes delegation of electoral authority to agencies staffed by detached, non-partisan experts \citep{Eisenstadt2004}.

This Council-General ran three competitive elections in which incumbents suffered important losses. The Institutional Revolutionary Party (PRI) lost control of Congress after seven decades of uninterrupted rule in the 1997 midterms, and then lost the presidency to the Partido Acci\'on Nacional (PAN) in 2000. The PAN was relegated to second place in Congress in the 2003 midterms. Yet losers accepted the outcome in these years.

But the 2003 council, unlike its predecessor, was negotiated without consensual support in the Chamber of Deputies.  In the last minute, the Party of the Democratic Revolution (PRD) broke off negotiations and was ignored by the other major parties in councilor selection. The PRD immediately accused IFE of a lack of autonomy from political parties.  And the 2006 election acquired a distinctively anticlimatic flavor when loser Andr\'es Manuel L\'opez Obrador, candidate of the PRD, cried foul and contested the PAN's Felipe Calder\'on's razor-thin margin of victory, using mass mobilization to challenge democratic rules.

We do not contest the claim that IFE's Council-General brought credibility to Mexican elections, but are not persuaded that this is the consequence of non-partisan impartiality, as the ombudsman model assumes. Nor do we agree with the view that the recent post-election dispute is precisely the result of replacing an autonomous IFE with a particised one.  IFE's institutional setup is analyzed as a response to standard problems of delegation: parties carefully select their representatives to IFE and have tools to induce them, within limits, to act in accordance with their interests. Our view is that political parties, not technocrats, are \emph{precisely} the ones that run the show at IFE. In this regard, IFE can be considered to be closer to a checks-and-balances ``party watchdog'' model than to an ombudsman model.  And it was precisely the lack of full checks-and-balances--- \emph{not} a rebirth of undue partisan influences --- that made IFE's authority questionable to the PRD.

To substantiate this view that parties never relinquished control over the agent in charge of regulating their own behavior, the paper starts by fleshing out the various dilemmas that politicians confront in delegating authority to a regulatory agency (Section~\ref{S:delegation}). It then describes IFE's institutional design in Section~\ref{S:description}.  We show how, despite central guarantees against majority tyranny, parties avail themselves of an array of resources to influence decisions in the Council-General. Ultimately, IFE's institutional setup suggests that councilors will be sensitive to the goals of their party sponsors, even in the absence of formal ties to political parties. The paper then inspects councilor behavior for traces of partisanship in Section~\ref{S:estimation}. We employ MCMC estimation techniques to examine the voting record of all Electoral Councilors between October 30, 1996, and August 24, 2005, spanning the two entirely different councils.  These techniques allow inferences about the ideal points of council members in one-dimensional ideological space.  This statistical analysis uncovers patterns consistent with the party sponsorship interpretation of councilors' voting behavior both before and after the 2003 renewal of the Council-General.

\section{Delegation Dilemmas}\label{S:delegation}
We see IFE as an agent of the Mexican legislature, who has the power to appoint and remove the organ's governing board. Consequently, we analyze its institutional setup within the canonical literature on delegation.\footnote{For a general discussion of the logic of delegation, see \citet[22-38]{Kiewiet1991}.}  In this light, parties in the enacting coalition delegate to their appointees authority to interpret the law and run federal elections.  From the perspective of those in the enacting coalition, two critical problems arise. One is how to reduce moral hazard that results from the Council General behaving in ways that do not serve the principals' common interests. The other arises from the fact that the enacting coalition is itself a collective principal, whose members have conflicting electoral interests.

The enacting coalition would like to set sufficient \emph{agency discretion} so as to take advantage of the agent's specialization, while at the same time limiting the possibility of excessive\emph{agency loss} \citep{Madison1788, Epstein1999, Huber2002, Miller2005}.  The literature has uncovered various, and often ingenious ways of mitigating this tradeoff.  But the heterogeneous nature of the enacting coalition complicates this by increasing the scope of the definition of agency loss.  In this sense, IFE is a regulatory board who has to serve the interests of a very broad constituency if it is to achieve credibility and trust in elections.

The question is how much influence can parties retain in IFE while achieving credibility.  We interpret recent work in ``agencies of restraint'' \citep{Schedler1999, Eisenstadt2004} as suggesting that anything short of full abdication (``autonomy'') impedes trust and credibility.  It is important to ask who is involved in the credibility game to evaluate this conclusion.  The tacit premise is that it is citizen trust in the electoral authority's independence and impartiality that matters most.  Public opinion corroborates this view: nearly two-thirds of respondents in a May 2005 survey considered IFE trustworthy, more so than any other political institution in the country.\footnote{The organizations that IFE regulates received much less support in citizen evaluations.  Only one in three respondents expressed any degree of trust in political parties.  See national face-to-face survey, May 20-22, 2005, in\emph{Reforma} supplement \emph{Enfoque}, June 5, 2005, p. 6.}.

On the contrary a partisan perspective, such as ours, departs from the premise that it is parties whose confidence in IFE is most important.  Only when those subject to its regulation believe in IFE's aura of effectiveness and fairness will they be willing to concede defeat in the competition for power.  Not that citizens are unimportant, but public opinion tends to follow party cues in this respect.\footnote{Panel surveys reported by Estrada and Poir\'e (2007) permit comparisons of democratic attitudes among supporters of losing candidates. PRD voters were more distrustful to begin with, a quarter of them expressing that Mexico is not a democracy both before and after the election, compared to 13\% of PRI voters. But differences accentuated after July 2.  Another quarter of PRD voters, who had originally expressed trust in democracy, joined the distrustful camp after losing.  Only 10\% of PRI voters did the same. So after the election half PRD voters did not believe in Mexican democracy, compared to slightly less than a quarter of PRI voters (and 16\% of PAN voters). Differentials are likely products of elite cues in the pre- and, especially, post-election disputes.} From our perspective of trust and confidence, it becomes crucial that IFE is \emph{not autonomous} from partisan influence.

We argue that, in structuring IFE, parties have managed to both retain influence in IFE and at the same time check each other's ambition.  The solution takes advantage of the agent's collective nature: the Council-General is a nine-member body sitting atop IFE's bureaucracy.  Naming it in such a way that all parties in the enacting coalition in the chamber of deputies have representation becomes a checks-and-balances solution to the dual dilemma. Minority representation, rather than an autonomous ombudsman, protects the interests of parties with IFE representation while simultaneously signaling that no single party will be able to manipulate elections.
...
Councilors who directly represented the major congressional
parties.\citet{Rosas2004} inspects the complete voting record of
this Council-General and finds support for \citeauthor{Malo1996}'s
...
agreed, in bargaining sessions over councilor selection since
1994,that no single party should designate a majority on the
council, that each party in the enacting coalition is entitled to
propose a share of councilors roughly proportional to its lower
chamber seat share, and that nominated candidates can be vetoed by
any other party in the coalition \citep{Alcocer1995, Schedler2000a}.
After the election of a single nominee for Council President, a
final logroll in the lower chamber on a closed list of eight
candidates(plus a ranked list of replacements) culminates the
process.  In 1996, all parties with congressional representation
(PRI, PAN, PRD, and PT) joined the enacting coalition; in 2003, only
three of six congressional parties were included.\footnote{The PT is
...
Ecologista Mexicano} (PVEM) was incorporated.}
Table\ref{T:proposals} shows information about the enacting
coalitions formed in 1996 and 2003, the relative strength of
legislative parties and the number of candidates that each party
...
flexible, over-representing the PRD until 2003.  In 1994 it received
three of six Citizen Councilors.  The PRI accepted this distribution
shielded behind its control of the then powerful Council presidency.
The PRD again demanded bigger representation in 1996 and got it,
although its third member had to be co-sponsored with the
PT(Councilor Cant\'u).  The PAN accepted to sponsor two members only
in exchange for strengthening the Council-General's powers vis-à-vis
IFE's bureaucracy.  In 2003 it was the PRI, having just re-gained
plurality status in the chamber, who demanded four seats in the new
Council-General--- party leader Emilio Chuayffet was fond of echoing
would-be presidential candidate Roberto Madrazo's claim to five
seats.  Since PAN demanded the sponsorship of three members, the PRD
insisted on the acceptance of Mr. Cant\'u as Council-President as
compensation; on whom the PRI was unwilling to lift its veto.  At a
quarter hour before deadline, and confronted with obstination by the
PRD, PAN and PRI kept four seats to themselves (the PRI sponsoring
Council-President Ugalde) and offered the ninth member to the Green
party (PVEM) instead.  (**Necesitamos una fuente para esto????)
...
No party was willing to concede to the PRD's maximalist demands in
2003, as in previous negotiations, leaving it without IFE
representation.  From the partisan perspective we are developing
this sign was ominous, a harbinger of electoral distrust to come
arising from incomplete checks-and-balances in the renewed
Council-General.
...
elective office has been frozen in Congress since 2001.}
Table\ref{T:postife}---which includes the list of Citizen Councilors
from1994-1996---speaks to this issue.  Ironically, the parties that
...
members will represent the views on electoral regulation of their
sponsoring party, i.e., councilors should manifest partisan
...
agreements among the members of its enacting coalition.
Inconsequence, a large volume of decisions should be characterized
by consensus among council members.  In addition, councilors retain
...
this still modest definition of conflict, less than 16\% of all roll
calls at IFE would qualify as divided votes in the period under
...
\begin{center}
\usepackage{graphicx}
\includegraphics[width=120mm]{"/data/1new/ife_cg/fig1.eps"}
...
behavior can be seen as agency losses.  Even allowing for slack due
...
partisanship are quite common. A search of \emph{Reforma}'s database
since 1996 uncovered a total of 41 impeachment threats articulated
by political parties (28 were issued during Woldenberg I, eight
during Woldenberg II, and five under Ugalde).  Four ``official
...
%%**Need to update the number of threats of impeachment in Ugalde's Council from Reforma database
...
company.  An abstention is always counted as a dissenting vote,
which in three-member contingents opens the rare possibility of each
voting differently (8 for the PRD in Woldenberg I, 6 for the PRI in
...
PRD & 0 &  18 &  8\% & & 90 & 27\% && --- & --- \\
 &    1 & 212 & 89\% & &243 & 73\% && --- & --- \\
 &    2 &   8 &  3\% & &--- & ---  && --- & --- \\
\hline \multicolumn{10}{l}{*{\small The series of roll-call votes for the Woldenberg Council starts October 1996; that for the Ugalde Council is truncated at June 2006.}}
\end{tabular}
\end{center}
\end{table}
...
%%**Necesitamos los nuevos números del TRIFE

{\sc Trife} is a busy court, as the evidence in Table
\ref{T:rulings} suggests, and has received a growing number of
appeals since 1996.  Of the total of 1,699 roll-call decisions from
the council, 218 have been challenged in court, involving 234
separate measures in 423 separate suits (IFE logrolls and multiple
plaintiffs increase the number of appeals).  Moreover, the tempo of
appeals has risen over time, from 1-in-9 decisions challenged during
Woldenberg I, to 1-in-5 for the Ugalde Council.  At the other end,
{\sc Trife} also grants appeals, in part or in whole, at twice its
earlier rate, currently overruling IFE in one out of twelve
roll-call votes.
...
2003-2005* & Appeal denied &  27 &  13\% \\
          & IFE overruled &  17 &   8\% \\
          & All           & 215 & 100\% \\
\hline \multicolumn{4}{l}{*{\small Appeals to Ugalde' Council
tracked until April 2005. We will have the full record for the 513
Ugalde votes until October 2006 by the end of January 2007, by which
time we will include it in the revised paper.}}
\end{tabular}
\end{center}
\end{table}
...
consensual one---Bayesian Monte Carlo Markov Chain methods provide
the best way to generate valid inferences about councilors'
ideological profiles, provided that our models are appropriately
specified through suitable priors.
...
%OMITTED TEXT For a discussion of alternative ways of modeling abstentions in IFE's Council-General see  \citet{Rosas2005}.}
...
A discussion of this structure is in order. Most issues voted at IFE
fall in two general categories. First, the pace of reform to
liberalize political competition. This category of issues
corresponds to the second dimension of Mexican politics described by
\citeauthor*{Molinar1991}\citeyearpar{Molinar1991} and
\citeauthor*{Lujambio2001}\citeyearpar{Lujambio2001}, among others,
and substantiated by
\citeauthor*{Moreno2005}\citeyearpar{Moreno2005} and
\citeauthor*{Magaloni2006}\citeyearpar{Magaloni2006}. How easy
should it be to replace top- and mid-level bureaucrats appointed by
the PRI in the previous IFE incarnation? Should IFE have full
authority to penalize vote-buying? Second, the scope of authority to
defend citizen rights against party encroachments
\citep[cf]{C\'ardenas2003}. Should IFE intervene to ban negative
campaigns ads, seen by many in Mexico as contrary to citizen
interest? Or to defend rank-and-file rights versus party leaders?
Interviews with former Councilors Lujambio and Molinar corroborated
that our choice of anchors, listed in Table~\ref{T:priors}, is
sensible to what they saw as the principal themes discussed during
their tenure at IFE and afterwards.\footnote{We stipulate standard
normal prior distributions on councilors' ideal points to solve the
problem of scaling invariance. For each of our datasets, we ran
200,000 iterations of the WinBugs sampler, discarding 100,000 as
burn-in and thinning the resulting chain so as to keep 10,000 draws
from the posterior distribution for inference purposes. We monitored
...
a brief technical description of the model in a web appendix.}
Issues in the first category were dominant in the first years,
issues in the second in the latter years, especially in the Ugalde
Council. Yet categories retain much overlap, the PRD standing on one
end, the PRI in the other. The PAN adopted positions somewhere in
the middle, at times allying with the PRD, at others obtaining key
concessions from the PRI in exchange for support for policy in the
Chamber of Deputies.

%%%La segunda definicion la sacamos del libro de Jaime Cardenas, quien se refiere a la division entre aquellos a favor de la plena "ciudadanizacion" del IFE (la izquierda) y los defensores de los intereses creados de los partidos (la partidocracia, pues, en la derecha). No se sobreponen perfectamente estas dos definiciones, y sobreviven mas rasgos de la de Cardenas que de la partidista en el consejo de Ugalde (Latapi es la heredera).  Pero sin duda, la retorica perredista hace diez y quince anyos (y a lo mejor, hoy tambien) ha sido mas ciudadanizante que los discursos del PAN y PRI. En la practica, aunque la mezquindad partidista nunca ha sido ajena al PRD, los riesgos que el PRD ha estado dispuesto a correr con "sus" consejeros siempre fueron mayores que los que corrieron sus rivales. Zertuche, Cardenas, Barragan, Cantu, Zebadua -- ninguno de ellos cercano al partido o a la corriente, pero un par de ellos cercanos al ingeniero.  Voces "independientes" de los medios en tiempos mucho mas riesgosos -- Ortiz Pinchetti, Granados Chapa, Cantu.  En ese sentido, los consejeros del PRD fueron mas representativos de la ciudadania que los escogidos por los otros dos partidos grandes.

%%%Los temas que usamos para anclar la segmentacion reflejan en buena medida estas preocupaciones que conllevan division del voto en el IFE.  Primero, esta el conflicto ciclico en torno a la delegacion o no de facultades de decision al consejero presidente.  Debe centralizarse el poder de postulacion de funcionarios en el IFE o debe compartirse ese poder entre los demas miembros del consejo? Woldenberg y Ugalde piensan preferible el presidencialismo al consenso parlamentario (antiguo regimen versus el nuevo).El segundo issue es igualmente revelador: deben pesar mas los derechos del rank-and-file que los de las dirigencias partidistas? O en una variacion sobre el mismo tema, deben participar mas las organizaciones ciudadanas (como Alianza Civica) o solamente las partidistas? Simplificando algo, estos issues se subsumen todos en la segunda dimension de regimen.  Por tanto, aunque el PRD este fuera del consejo de Ugalde, y seguramente ningun consejero es un Cardenas o un Cantu, la izquierda en al segunda dimension sigue estando representada por los panuchos y los disidentes del PRI.

%%%Pero esa aclaracion no basta para deshacernos de la pregunta sobre el sentido de la izquierda hoy en el CG.  Si "la" izquierda denuncia al IFE por corrupto, falible, vendido y fraudulento, no podemos usar el mismo lenguaje de los anyos noventa.  Sugiero cambiar los terminos de referencia al binomio "political liberals/political conservatives".  Lo que pide el PRD hoy respecto del IFE no es muy distinto en espiritu a lo que pedian Cardenas y Cantu hace algunos anyos.  Recuentos, equidad, castigos eficaces, regulacion efectiva, neutralidad quisquillosa -- todo ello encaja perfectamente en una agenda de ciudadanizacion (y menos bien con la defensa de la partidocracia).  Balanceemos, si quieren, con mayor enfasis sobre el espectro acortado, trunco, a partir de 2003.  Pero no cedamos mas que eso.
...
predispositions.}  We interpret this as a reflection of obvious
changes in the issue space that accompanies the replacement of two
councilors.  In the first place, the PRI contingent is enlarged by
the turnover, which modifies coalitional dynamics in its favor,
inducing Lujambio toward a tight-locked alliance on the right.  This
change in voting power is reinforced by the unexpected salience of
the dominant issues resolved under Woldenberg II, which involved
charges of illegal campaign finance operations in 2000 against both
the PAN and the PRI.\footnote{Former Councilor C\'ardenas
consistently refused to join the majority in the resolutions on both
...
regulation, corresponding in our analysis to liberal versus
conservative. Of course, C\'ardenas's persistent position on the
...
\begin{center}
\usepackage{graphicx}
  %\includegraphics[width=120mm]{"C:/Documents and Settings/Guillermo Rosas/My Documents/MY RESEARCH/PROYECTO IFE/paper ERIC/graficas ERIC/newest graphs/w1_w2_ug.eps"}
\includegraphics[width=120mm]{"/data/1new/ife_cg/w1_w2_ug.eps"}
...
neither the ideological dimensions nor the individual measures of
spread are directly comparable across councils.  One can appreciate
in the figures, for example, that PRI-sponsored council members in
each half of the Woldenberg Council are virtually indistinguishable
from each other, with overlapped ideal point ranges a sure sign of
coalescent voting patterns in contested roll calls. Stacking of
ranges in the Ugalde Council dropped significantly for all members,
including the PRI sponsored. PAN's nominees stacked in the first
half of the Woldenberg Council, but not afterwards. The PRD's blocs
never stacked. In the event, only four of eight multi-member
contingents appear to exhibit the clustering of ideal point ranges
that would signify fully consistent partisan bloc voting.

It is also interesting to note that member stacking dropped after
the 2003 Council renewal. If bloc voting is a trait of partisanship,
then the Ugalde Council appears \emph{less} partisan than any of the
Woldenberg Council's halves, which contradicts the view to the
contrary wide held in the campaign and post-election disputes.
...
in Table~\ref{T:anova} which consider only the ideal points of
...
analysis of the posterior distribution of ideal points provides
evidence that the average Electoral Councilor routinely votes in
alignment with other colleagues nominated by the same party sponsor.
Moreover, there is partial evidence that council members grouped by
party sponsor share ideal point ranges that cluster into discernible
partisan blocs.  To that same extent, councilors are closer to their
sponsors' hearts than might be expected in an ostensibly
non-partisan electoral authority.

Our findings jibe with a view that legislative parties structure IFE
in such way to retain and employ mechanisms to control regulatory
agent behavior within the Council-General. We conclude that if the
bulk of IFE decisions had been above the political fray and free of
partisan bickering, as is widely believed, this is not because its
members were embodiments of technocratic efficiency and
impartiality. Instead, councilors behave as ``party watchdogs'',
able to check each other's moves and assure compromises that protect
their sponsors' interests in the electoral arena.

For this power-sharing model to work, all major parties should be
represented. The absence of the PRD in the enacting coalition that
named the most recent Council-General was cause for concern that
materialized in the aftermath of the 2006 presidential race. Because
parties anticipate that their interests will be guarded by their
sponsored council members and can be reasonably sure that agency
losses will be minor, they are willing to obey the occasional ruling
that hurts their short-term interests. Parties may more adamantly
oppose technocratic regulation if they suspect that their
preferences will not receive a fair hearing. In short, our analysis
lends credence to the claim that election arbiters that embrace
partisan strife, rather than those that purport to expunge party
politics altogether from electoral regulation, might be better able
to guarantee free and fair elections in new democracies.

%%IFE's \emph{raison d'\^etre} is to give parties confidence that none will be able to cheat in elections and that electoral results will be respected.  And the arrangement has been successful: Before 2006, three consecutive federal elections over twelve years had taken place with losing parties accepting the outcome.  Public opinion corroborates IFE's aura of effectiveness, independence, and impartiality.  Nearly two-thirds of respondents in a May 2005 survey considered IFE trustworthy, more so than any other political institution in the country.\footnote{Only one in three respondents expressed trust in political parties in the same survey.  See \emph{Reforma} supplement \emph{Enfoque}, June 5, 2005, p. 6.}  Even after disputes ensued during the presidential election of 2006, levels of trust in IFE remained rather stable.\footnote{AGAIN, SOME EVIDENCE HERE IS NEEDED.}   The paradox of Mexico's success story is that, as discussed and substantiated below, IFE has been and remains a \emph{dependent agent}.  Parties have not given away full control of the levers of electoral regulation and yet benefit from the reputation that elections are clean.  The credibility and trust in IFE that surveys unambiguously detect in public opinion does in fact coexist with a Council General whose members, when voting, cleave along predictable partisan lines.  The next section discusses the powers parties have to influence IFE policy and presents our party sponsorship hypothesis.
...
%
%\bibitem C\'ardenas, Jaime. 2003. \emph{} Mexico City:.
%
...
%
%\bibitem Estrada, Luis, and Alejandro Poir\'e. 2007. ``Learning to Lose, Taught to Protest: Mexico's 2006 Election''. \emph{Journal of Democracy} 18(1): pp.
%
...
%
%\bibitem Jones, Mark P. 1995. \emph{Electoral Rules and the Survival of Presidential Regimes}.
%
%\bibitem Kiewiet, Roderick, and Mathew D. McCubbins. 1991. \emph{The Logic of Delegation}. Chicago: University of Chicago Press.
%
%\bibitem Linz, Juan J., and Alfred Stepan. 1978.
%
...
%
%\bibitem Magaloni, Beatriz. 2006.  \emph{Voting for Autocracy}. New York: Cambridge University Press.
%
...
%
%\bibitem Molinar, Juan.  1991.  \emph{El tiempo de la legitimidad}.  Mexico City: Cal y Arena.
%
%\bibitem Moreno, Alejandro.  2005.  \emph{El votante mexicano}.  Mexico City: Fondo de Cultura Econ\'omica.
%
%\bibitem NDI. 2006. ``Statement of the NDI pre-election delegation to Mexico's July 2, 2006 Presidential Election,'' available at http://www.accessdemocracy.org/library/2003_mx_preeelct_040906.pdf.  Washington, DC: National Democratic Institute for International Affairs.
%
...
%
%\bibitem Przeworski, Adam. 1991. \emph{Democracy and the Market: Political and Economic Reforms in Eastern Europe and Latin America}.  New York: Cambridge University Press.
%
%\bibitem Putnam, Robert. 2000. \emph{Bowling Alone: The Collapse and Revival of American Community}. New York: Simon & Shuster.
%
%\bibitem Romer, Thomas, and Howard Rosenthal. 1978. ``Political Resource Allocation, Controlled Agendas, and the Status Quo.'' \emph{Public Choice} 33:27-44.
%
...
%\tablelasttail{\hline}
%Memo: es possible poner este cuadro en version horizontal en una pï¿1/2ina separada? (o de forma que entre en una pagina)
