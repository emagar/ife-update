...
%\usepackage{graphicx}
\graphicspath{"d:/01/Dropbox/data"}
\usepackage{color}
...
%%    \includegraphics[width=.8\textwidth]{d:/01/data/rollcall/ife_cg/graphs/all+divVotsSemestre.pdf} \\
    \includegraphics[width=.8\textwidth]{../graphs/all+divVotsSemestre.pdf} \\
...
%%    \includegraphics[width=.48\textwidth]{d:/01/data/rollcall/ife_cg/graphs/1dimDynUgaVal0410j.pdf} \\
    \includegraphics[width=.48\textwidth]{../graphs/1dimDynWold9703jmayorPrecision.pdf} &
    \includegraphics[width=.48\textwidth]{../graphs/1dimDynUgaVal0410j.pdf} \\
  \end{tabular}
...
%%    \includegraphics[width=.48\textwidth]{d:/01/data/rollcall/ife_cg/graphs/driftUVlines.pdf} \\
    \includegraphics[width=.48\textwidth]{../graphs/driftWlines.pdf} &
    \includegraphics[width=.48\textwidth]{../graphs/driftUVlines.pdf} \\
  \end{tabular}
...
%%    \includegraphics[width=.48\textwidth]{d:/01/data/rollcall/ife_cg/graphs/minmaxmedUgVal.pdf} \\
    \includegraphics[width=.48\textwidth]{../graphs/minmaxmedWol.pdf} &
    \includegraphics[width=.48\textwidth]{../graphs/minmaxmedUgVal.pdf} \\
  \end{tabular}
...
%%    \includegraphics[width=.48\textwidth]{d:/01/data/rollcall/ife_cg/graphs/allUVdyn.pdf} \\
    \includegraphics[width=.48\textwidth]{../graphs/allWdyn.pdf} &
    \includegraphics[width=.48\textwidth]{../graphs/allUVdyn.pdf} \\
  \end{tabular}
...
%%    \includegraphics[width=.3\textwidth]{d:/01/data/rollcall/ife_cg/graphs/woStackPRD.pdf} \\
    \includegraphics[width=.3\textwidth]{../graphs/woStackPRI.pdf} &
    \includegraphics[width=.3\textwidth]{../graphs/woStackPAN.pdf} &
    \includegraphics[width=.3\textwidth]{../graphs/woStackPRD.pdf} \\
    (d) & (e) & (f)\\
...
%%    \includegraphics[width=.3\textwidth]{d:/01/data/rollcall/ife_cg/graphs/ugvalStackPAN.pdf} \\
    \includegraphics[width=.3\textwidth]{../graphs/ugvalStackPRImadPVEM.pdf} &
    \includegraphics[width=.3\textwidth]{../graphs/ugvalStackPRIelba.pdf} &
    \includegraphics[width=.3\textwidth]{../graphs/ugvalStackPAN.pdf} \\
    (g) &  & \\
%%    \includegraphics[width=.3\textwidth]{d:/01/data/rollcall/ife_cg/graphs/ugvalStackPRD.pdf} & & \\
    \includegraphics[width=.3\textwidth]{../graphs/ugvalStackPRD.pdf} & & \\
  \end{tabular}
...
%%    (b) \\ \includegraphics[width=.9\textwidth]{d:/01/data/rollcall/ife_cg/graphs/winsizeStackCont.pdf} \\
    (a) \\ \includegraphics[width=.9\textwidth]{../graphs/winsizeStackUnan.pdf} \\
    (b) \\ \includegraphics[width=.9\textwidth]{../graphs/winsizeStackCont.pdf} \\
