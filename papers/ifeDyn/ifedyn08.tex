...
We analyze all contested roll-call votes in IFE's Council General between October 1996 and April 2014. For one model specification, we aggregate data quarterly. A vote qualifies as contested when, ignoring absences and abstentions, at least one councilor voted contrary to the rest of the Council. This filter removes from the dataset 5,202 unanimous votes which fail to distinguish councilors from one another, leaving a subset of 1,640 roll call votes equivalent to 24\% of the universe of decisions in the Council General. 
