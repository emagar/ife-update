...
\title{Partisanship Among the Experts: \\ Agency Costs in Election Regulation\thanks{We are grateful to Andrew Martin for comments and critiques to an earlier version and to Omar Alejandre for sharing data on originating IFE committees. For generous support, Magar thanks the Asociaci\'on Mexicana de Cultura A.C.\ and Rosas thanks the Weidenbaum Center at Washington University. Authors are responsible for any errors.}}
